<?php
/*
Plugin Name: LesPaul Demo Content Importer
Plugin URI: http://www.webmandesign.eu/
Description: Import demo content XML file of LesPaul WordPress theme by WebMan. IMPORTANT: Please, disable the WordPress Importer plugin first (if you have it installed and enabled) and import theme's demo data following instructions in user manual.
Author: WebMan
