...
array(
	...
	array(
		...
		array(
			...
			"desc-export" => __( 'To export the current settings copy and keep (save to external file) the settings string below', 'lespaul_domain_panel' ),
			"label-import" => __( 'Import', 'lespaul_domain_panel' ),
			"desc-import" => __( 'To import previously saved settings, insert the settings string below. Note that by importing new settings you will loose all current ones. Always keep the backup of current settings.', 'lespaul_domain_panel' )
		),
		array(
			"type" => "hrtop"
		),
