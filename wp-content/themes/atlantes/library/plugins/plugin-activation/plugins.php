...
function my_theme_register_required_plugins() {
	...
	*/
	 ...
	 */
	$config = array(
		'domain'           => 'atlantes_domain_adm', // Text domain - likely want to be the same as your theme.
		...
		'strings'          => array(
			'page_title'                      => __( 'Install Required Plugins', 'atlantes_domain_adm' ),
			'menu_title'                      => __( 'Install Plugins', 'atlantes_domain_adm' ),
			'installing'                      => __( 'Installing Plugin: %s', 'atlantes_domain_adm' ), // %1$s = plugin name
			'oops'                            => __( 'Something went wrong with the plugin API.', 'atlantes_domain_adm' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'atlantes_domain_adm' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'atlantes_domain_adm' ),
			'complete'                        => __( 'All plugins installed and activated successfully. %s', 'atlantes_domain_adm' ), // %1$s = dashboard link
