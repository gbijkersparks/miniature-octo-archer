...
array(
	...
	"title" => __( 'Footer', 'atlantes_domain_panel' )
),
	...
	array(
		...
		"list" => array(
			__( 'Website footer', 'atlantes_domain_panel' ),
			)
	),
	...
	array(
		...
		"title" => __( 'Website footer', 'atlantes_domain_panel' )
	),
		array(
			"type" => "heading3",
			"content" => __( 'Footer credits', 'atlantes_domain_panel' ),
			"class" => "first"
		),
			array(
				"type" => "textarea",
				"id" => $prefix."credits",
				"label" => __( 'Credits (copyright) text', 'atlantes_domain_panel' ),
				"desc" => __( 'Copyright text at the bottom of the website. You can use YEAR for dynamic (always current) year.', 'atlantes_domain_panel' ),
