		...
		function wm_staff_cp_init() {
			...
			$args = array(
				...
				'labels'              => array(
					...
					'singular_name'      => __( 'Staff member', 'atlantes_domain_adm' ),
					'add_new'            => __( 'Add new member', 'atlantes_domain_adm' ),
					'add_new_item'       => __( 'Add new member', 'atlantes_domain_adm' ),
					'new_item'           => __( 'Add new member', 'atlantes_domain_adm' ),
					'edit_item'          => __( 'Edit member', 'atlantes_domain_adm' ),
					'view_item'          => __( 'View member', 'atlantes_domain_adm' ),
					'search_items'       => __( 'Search members', 'atlantes_domain_adm' ),
					'not_found'          => __( 'No member found', 'atlantes_domain_adm' ),
					'not_found_in_trash' => __( 'No members found in trash', 'atlantes_domain_adm' ),
					'parent_item_colon'  => ''
				)
			);
	...
	if ( ! function_exists( 'wm_staff_cp_columns' ) ) {
		function wm_staff_cp_columns( $wm_staffCols ) {
			...
			$wm_staffCols = array(
				...
				$prefix . "thumb"      => __( 'Photo', 'atlantes_domain_adm' ),
				"title"                => __( 'Name', 'atlantes_domain_adm' ),
				$prefix . "position"   => __( 'Position', 'atlantes_domain_adm' ),
				$prefix . "department" => __( 'Department', 'atlantes_domain_adm' ),
